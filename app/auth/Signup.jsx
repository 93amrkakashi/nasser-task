    ...
    return (
      <div className="bg-white p-8 rounded shadow-md">
        ...
        <form>
          ...
          <button type="submit" className="w-full bg-blue-500 text-white p-2 rounded mt-4">إنشاء حساب</button>
        </form>
        <p className="mt-4 text-center text-sm text-gray-600">
          لديك حساب؟ <button onClick={toggleAuth} className="text-blue-500 hover:underline">تسجيل الدخول</button>
        </p>
      </div>
    );
  }
